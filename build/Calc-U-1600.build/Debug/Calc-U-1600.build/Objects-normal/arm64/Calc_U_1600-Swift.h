...
#ifndef CALC_U_1600_SWIFT_H
#define CALC_U_1600_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Calc_U_1600",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSDate;
@interface Item (SWIFT_EXTENSION(Calc_U_1600))
