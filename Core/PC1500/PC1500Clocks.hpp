...
// One 60 Hz frame of CPU cycles: the unit the key-scan cadence (tap/idle
// frames) and the headless loaders step in.
inline constexpr uint64_t kPC1500CyclesPerFrame = kPC1500CpuHz / 60;
